...
class MnistLSTMClassifier(object):
    ...
    def __create_model(self):
        ...
        self.model.add(LSTM(self.n_units, return_sequences=True, input_shape=(self.time_steps, self.n_inputs)))  # returns a sequence of vectors of dimension 32
        self.model.add(LSTM(self.n_units, return_sequences=True))  # returns a sequence of vectors of dimension 32
